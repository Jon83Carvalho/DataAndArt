...
import {select,caleLog,scaleOrdinal,extent,format,csv,scaleBand,scaleLinear,max,ascending,descending,cos,sin,min} from 'd3';
...
export const Viz2=({yAxislabelOffset,xAxislabelOffset,marginTop,marginRight,marginBottom,marginLeft})=>{
 ...
 const xScale=scaleLinear()
  ...
  <svg width={width} height={height} style={{backgroundColor:"#222367"}}>
        ...
        <g transform={`translate(${0.02*width},0)`}>
         <StockMarks 
          data={data} 
          xScale={xScale} 
          yScale={yScale}
